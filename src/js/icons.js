...
const ICONS = {
  printed: `<svg viewBox="0 0 100 130" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M33 40 L36 20 Q37 12 47 12 L53 12 Q63 12 64 20 L67 40" fill="none" stroke="#00c500" stroke-width="4" stroke-linecap="round"/>
    <rect x="8" y="37" width="84" height="8" fill="#dcece1"/>
    <circle cx="50" cy="60" r="12" fill="none" stroke="#00c500" stroke-width="3"/>
    <path d="M45 60h10M50 55v10" stroke="#00c500" stroke-width="2.5" stroke-linecap="round"/>
    <rect x="20" y="82" width="60" height="12" rx="3" fill="#00c500"/>
  ...
  plain: `<svg viewBox="0 0 100 130" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M33 40 L36 20 Q37 12 47 12 L53 12 Q63 12 64 20 L67 40" fill="none" stroke="#00c500" stroke-width="4" stroke-linecap="round"/>
    <rect x="8" y="37" width="84" height="8" fill="#dcece1"/>
    <rect x="20" y="66" width="60" height="14" rx="3" fill="#00c500"/>
  ...
  custom: `<svg viewBox="0 0 100 130" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M36 44v-8a14 14 0 0 1 28 0v8" fill="none" stroke="#00c500" stroke-width="4" stroke-linecap="round"/>
    <rect x="30" y="62" width="40" height="26" rx="4" fill="#00c500"/>
